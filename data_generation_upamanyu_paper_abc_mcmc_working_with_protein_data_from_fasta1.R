...
main_function=function(pro_trt_file,pep_trt_file,pro_cntrl_file,pep_cntrl_file,noise_factor,theta_a,number_of_samples_train_cntrl,number_of_samples_train_trt,
                     number_of_samples_test_cntrl,number_of_samples_test_trt,amin,amax,k0,theta0,phi0,al0,M_cal,markov_iter)
{
#noise_factor=1500
##print(getwd())
#print("popo123")
...
xlj_all=peptide_generation(gamma_vec,fold_change_vec,phi_opt,Npro_cntrl,Npep_cntrl,Npro_trt,Npep_trt,prot_pept_list_cntrl,Npro_for_analysis,
                               prot_pept_list_cntrl_test,prot_pept_list_trt,prot_pept_list_trt_test,train_test_flag)

train_test_flag=0
xlj_all_test=peptide_generation(gamma_vec,fold_change_vec,phi_opt,Npro_cntrl,Npep_cntrl,Npro_trt,Npep_trt,prot_pept_list_cntrl,Npro_for_analysis,
                                    prot_pept_list_cntrl_test,prot_pept_list_trt,prot_pept_list_trt_test,train_test_flag)
...
markov_Data=peptide_generation(gamma_vec,fold_change_vec,phi_opt,Npro_cntrl,Npep_cntrl,Npro_trt,Npep_trt,prot_pept_list_cntrl,Npro_for_analysis,
...
if(1){
  for(i in 1:nrow(xlj_all_test)){
    ...
    count_123=0
    ###print("here man")
    for(j in (ceiling(0.4*markov_iter)):(markov_iter)){
      ...
      for(k in 1:(markov_length_class)){
        ...
        if(1){
          ...
          diff_data_zero=diff_data_zero/7000
...
noise_factor=1
theta_a=100
number_of_samples_train_cntrl=15 #number of samples in each class
number_of_samples_train_trt=15

number_of_samples_test_cntrl=10 #number of test samples fr control
number_of_samples_test_trt=10
amin=1.5
amax=1.6
k0=2
theta0=100
