...
t=2
theta_a=1000
number_of_samples=2 #number of samples in each class
...
c_pep_treatement_test=matrix(numeric(Npep_trt*number_of_samples_test_trt),nrow = number_of_samples_test_cntrl)
