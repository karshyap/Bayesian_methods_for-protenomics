...
for(j in 1:M_cal){
  ...
  ###print(thresh_key)
  ###print(count_1)
  if(norm_array[j]<6*thresh_key_cntrl){
    ###print("gugshi")
    ###print(j)
    count_1=count_1+1
    k_list[count_1]=k
...
for(i in 1:Npro_cntrl){
  gamma_l_opt[i]=sample(gamma_dist_opt,1)
}
                             ...
                             prot_pept_list_cntrl_test,prot_pept_list_trt,prot_pept_list_trt_test,train_test_flag,number_of_samples_train_cntrl,number_of_samples_train_trt)
{
  ...
  #efficiency_vector=runif(Npep,0.99,0.999)
  
  #kappa=1
  #efficiency_vector=rep(1,Npep)
