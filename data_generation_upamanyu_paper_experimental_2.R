...
while(norm_cntrl>thresh_key_cntrl | norm_trt>thresh_key_trt){
  # #print("i am here")
  ##print(norm_cntrl)
  ##print(norm_trt)
  for(i in 1:Npro_cntrl){
...
train_test_flag=1
xlj_all=peptide_generation(gamma_vec,fold_change_vec,phi_opt,Npro_cntrl,Npro_trt,prot_pept_list_cntrl,Npro_for_analysis,
                           prot_pept_list_cntrl_test,prot_pept_list_trt,prot_pept_list_trt_test,train_test_flag)

train_test_flag=0
xlj_all_test=peptide_generation(gamma_vec,fold_change_vec,phi_opt,Npro_cntrl,Npro_trt,prot_pept_list_cntrl,Npro_for_analysis,
                           prot_pept_list_cntrl_test,prot_pept_list_trt,prot_pept_list_trt_test,train_test_flag)
...
if(1){
  for(i in 1:nrow(xlj_all_test)){
    ...
    if(total_outside_sum_one>total_outside_sum_zero){
      #if(outside_full_sum_one>outside_full_sum_zero){
